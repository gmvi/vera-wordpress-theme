		...
		if ( $orderby == '' && $order == '' ) { //default ordering for admin view is by end date
			$meta_query = array(
				...
				array(
					...
					'compare' => 'NOT EXISTS',
					// if we don't check for this, galleries without end dates will not show up
				),
				array(
					'key' => 'gallery_end_date',
				),
	...
	switch ( $column_name ) {
            ...
            <fieldset class="inline-edit-col-left">
                <div class="inline-edit-col">
                    <label class="alignleft inline-edit-private">
                        <input class="curr_gallery_check" type="checkbox"
		...
		case UP_NEXT_GALLERY:
            ...
            <fieldset class="inline-edit-col-left">
                <div class="inline-edit-col">
                    <label class="alignleft inline-edit-private">
                        <input class="up_next_gallery_check" type="checkbox"
                               name="<?php echo esc_attr( $column_name ); ?>">
