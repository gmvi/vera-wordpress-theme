	...
	<div class="<?php echo esc_attr( $container ); ?>" id="content" tabindex="-1">
		...
		<div class="row">
			...
			<div class="col-md-12 content-area" id="primary">
				...
				<main class="site-main container mx-auto my-4" id="main">
					...
					<section class="error-404 not-found">
						...
						<div class="page-content">
							...
							<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or search?',
									'understrap' ); ?></p>
